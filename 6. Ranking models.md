...
Si supponga di avere una variabile dicotomica (binaria). #Completa 
...
È lo stesso approccio usato nel modello BM25 (Whoosh e Lucene).
...
Il BIM fallisce per documenti in cui i termini si ripetono più volte o per documenti dalla lunghezza variabile. #Completa
